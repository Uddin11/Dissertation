...
def _get_args():
    ...
    default_model_dir = "/mnt/clusters/grayling/data/c22111854/ResearchProject/Data/SabDab_all_structures/all_structures/fasta/DeepAb/trained_models/ensemble_abresnet"
    parser.add_argument(
        "--model_dir",
        type=str,
