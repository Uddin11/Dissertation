...
#SBATCH --cpus-per-task=55       # number of CPUs per task
...
python /mnt/clusters/grayling/data/c22111854/ResearchProject/Data/SabDab_all_structures/Scripts/Hamming_distance_CDR.py 
